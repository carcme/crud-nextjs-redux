      ...
      <main className="py-5">
        ...
        <div className="container mx-auto flex justify-between py-5 border-b">
          <div className="left flex gap-3">
            ...
            rounded-md hover:bg-gray-50 hover:border-indigo-500 hover:text-indigo-500"
            >
              Add Employee
              <span className="px-1">
                <BiUserPlus size={23} />
  ...
  return (
    <div className="flex gap-5">
      ...
      <button
        ...
        hover:bg-red-700 hover:border-red-500 hover:text-gray-50"
      >
        Yes
        <span className="px-1">
      ...
      <button
        ...
        hover:bg-gree-500 hover:border-green-500 hover:text-gray-50"
      >
        No
        <span className="px-1">
